...
class StyleLibraryV060Tests(unittest.TestCase):
    ...
    def test_release_wires_style_library_into_all_high_precision_paths(self) -> None:
        ...
        runtime_service = (root / "standalone/ps_sezhao/services/runtime_service.py").read_text(encoding="utf-8")
        ...
        self.assertIn("apply_style_engine_patch", bootstrap)
        self.assertIn("apply_v060_style_library_patch", bootstrap)
        self.assertIn("source_crop_module.neutral_gains = engine_module.neutral_gains", runtime_service)
